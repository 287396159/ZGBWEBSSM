...
public class DescAccessComparator extends BaseAccessComparator {
	@Override
	public int compare(TagAccessRecord record1, TagAccessRecord record2) {
		// 防止出现异常: java.lang.IllegalArgumentException: Comparison method violates its general contract!
