...
public class SetArroundNodeWifiNameUdpPack extends BaseArroundSettingUdpPack{
	private static final long serialVersionUID = 1L;
	private static final int SIZE = 39;
	private static final byte TYPE = 0x09;
	public static final String KEY_NAME = "SetArroundNodeWifiNameUdpPack";
	@Override
