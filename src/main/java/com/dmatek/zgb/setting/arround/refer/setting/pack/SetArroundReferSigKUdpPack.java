...
public class SetArroundReferSigKUdpPack extends BaseArroundSettingUdpPack {
	private static final long serialVersionUID = 1L;
	public static final String KEY_NAME = "SetArroundReferSigKUdpPack";
	private static int SIZE = 7;
	private static byte TYPE = 0x47;
	@Override
