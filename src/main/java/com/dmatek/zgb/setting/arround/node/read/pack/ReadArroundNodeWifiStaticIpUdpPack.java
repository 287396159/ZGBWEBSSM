...
public class ReadArroundNodeWifiStaticIpUdpPack extends BaseArroundNodeReadUdpPack{
	private static final long serialVersionUID = 1L;
	private static final int SIZE = 7;
	private static final int BYTE_SIZE = 4;
	private static final byte TYPE = 0x1B;
	public static final String KEY_NAME = "ReadArroundNodeWifiStaticIpUdpPack";
