...
public class ReadArroundNodeWifiPswUdpPack extends BaseArroundNodeReadUdpPack{
	private static final long serialVersionUID = 1L;
	private static final int SIZE = 7;
	private static final int BYTE_SIZE = 32;
	private static final byte TYPE = 0x0C;
	public static final String KEY_NAME = "ReadArroundNodeWifiPswUdpPack";
