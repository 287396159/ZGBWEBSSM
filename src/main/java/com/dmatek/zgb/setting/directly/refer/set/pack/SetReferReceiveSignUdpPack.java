...
public class SetReferReceiveSignUdpPack extends BaseDirectlyReferSettingUdpPack {
	private static final long serialVersionUID = 1L;
	public static final String KEY_NAME = "SetReferReceiveSignUdpPack";
	private static final int SIZE = 7;
	private static final byte TYPE = 0x20;
	@Override
