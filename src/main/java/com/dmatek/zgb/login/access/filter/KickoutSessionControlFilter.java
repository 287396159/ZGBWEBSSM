package com.dmatek.zgb.login.access.filter;
...
public class KickoutSessionControlFilter extends AccessControlFilter {
	private String kickoutUrl;// 踢出后跳转的地址
	private boolean kickoutAfter = false; // 踢出之前登录的/之后登录的用户 默认踢出之前登录的用户
	private int maxSession = 1; // 同一个账号最大的会话数最多1个
	...
	public KickoutSessionControlFilter(String kickoutUrl, boolean kickoutAfter,
			int maxSession, SessionManager sessionManager,
		...
		this.kickOutMessageGetter = kickOutMessageGetter;
	}
	...
	public KickOutMessageGetter getKickOutMessageGetter() {
		return kickOutMessageGetter;
	}
	public void setKickOutMessageGetter(KickOutMessageGetter kickOutMessageGetter) {
		this.kickOutMessageGetter = kickOutMessageGetter;
	}
